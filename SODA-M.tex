...
Hence, in this paper, we generalize SODA to close the gap for stochastic optimization problems for processes that have feasibility constraints over multiple stochastic metrics while being described using non-linear arithmetic.
