...
The production process is a composition of three sub-processes of \textit{supply}, \textit{production}, and \textit{demand}. 
In turn the \textit{supply} sub-process contains the suppliers of the raw materials for the heat-sink part, which includes suppliers of \textit{aluminum}, \textit{heat-sink case} and \textit{accessories} such as screws, and bolts. 
